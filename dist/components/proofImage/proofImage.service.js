...
const list = () => __awaiter(void 0, void 0, void 0, function* () {
    return db_server_1.db.proofimage.findMany();
});
exports.list = list;
const get = (id) => __awaiter(void 0, void 0, void 0, function* () {
    return db_server_1.db.proofimage.findUnique({
        where: {
            id,
        },
    });
...
const create = (data) => __awaiter(void 0, void 0, void 0, function* () {
    return db_server_1.db.proofimage.create({
        data: data
    });
});
exports.create = create;
const update = (data, id) => __awaiter(void 0, void 0, void 0, function* () {
    return db_server_1.db.proofimage.update({
        where: id,
        data: data
    });
});
