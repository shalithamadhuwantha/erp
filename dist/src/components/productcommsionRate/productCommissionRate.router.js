...
const productCommissionRateService = __importStar(require("./productCommissionRate.service"));
...
exports.productDiscountRouter.get("/", (request, response) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const data = yield productCommissionRateService.list();
        if (data) {
...
exports.productDiscountRouter.get("/:id", (request, response) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
        const data = yield productCommissionRateService.get(id);
        if (data) {
            return response.status(200).json({ data: data });
        }
