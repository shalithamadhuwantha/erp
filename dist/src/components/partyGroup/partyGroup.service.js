...
const getlist = () => __awaiter(void 0, void 0, void 0, function* () {
    return db_server_1.db.partyGroup.findMany();
});
exports.getlist = getlist;
const getbyname = (name) => __awaiter(void 0, void 0, void 0, function* () {
    return db_server_1.db.partyGroup.findFirst({
        where: {
            partyGroupName: name
        }
    });
...
const getbyid = (id) => __awaiter(void 0, void 0, void 0, function* () {
    return db_server_1.db.partyGroup.findUnique({
        where: {
            id
        }
    });
...
const create = (data) => __awaiter(void 0, void 0, void 0, function* () {
    return db_server_1.db.partyGroup.create({
        data: data
    });
});
exports.create = create;
const update = (data, id) => __awaiter(void 0, void 0, void 0, function* () {
    return db_server_1.db.partyGroup.update({
        where: id,
        data: data
    });
});
